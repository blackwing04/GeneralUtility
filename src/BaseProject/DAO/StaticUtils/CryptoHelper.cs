...
namespace DAO.StaticUtil
{
    ...
    public class CryptoHelper
    {
        ...
        public static CryptoConnectionStringModel CreateEncryptModel(string connectionString)
        {
            CryptoConnectionStringModel Encrypt = new ()
            {
        ...
        public static string DecryptString(CryptoConnectionStringModel connectionString)
        {
            ...
            using (Aes aesAlg = Aes.Create())
            {
                ...
                using MemoryStream msDecrypt = new (Convert.FromBase64String(connectionString.CS));
